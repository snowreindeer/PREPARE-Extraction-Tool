...
export default function ClusterDetailModal({ cluster, onClose, onRefresh }: ClusterDetailModalProps) {
    ...
    const handleRemoveTerm = async (termId: number) => {
        ...
        try {
            ...
            // Update parent state without full refresh
            onRefresh();
            // If this was the last term, close modal
        ...
        <div className={styles.modalOverlay} onClick={onClose}>
            <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
                ...
                <div className={styles.modalBody}>
                    ...
                    <div className={styles.termsSection}>
                        <div className={styles.termsSectionHeader}>
                            ...
                            <button
                                onClick={() => setIsChangingMainTerm(true)}
                                className={styles.btnChangeMainTerm}
                            >
                                Change Main Term
                            </button>
                        </div>
                                        ...
                                        <tr key={term.term_id}>
                                            <td>
                                                <div className={styles.termCell}>
                                                    {term.text === cluster.title && (
                                                        <span className={styles.mainBadge}>main</span>
                                                    )}
                                                    {isChangingMainTerm ? (
                                                        <button
                                                            onClick={() => handleChangeMainTerm(term.text)}
                                                            className={styles.btnSelectTerm}
                                                        >
                                                            {term.text}
                                                        </button>
                                                    ) : (
                                            ...
                                            <td>
                                                <button
                                                    onClick={() => handleViewRecords(term.record_ids)}
                                                    className={styles.btnViewRecords}
                                                >
                                            ...
                                            <td>
                                                <button
                                                    onClick={() => handleRemoveTerm(term.term_id)}
                ...
                <div className={styles.modalFooter}>
                    ...
                    <button className={styles.btnMerge}>
                        Merge with Another
                    </button>
